...
#Locate the URL for the psping.exe file make sure to test the link before running the script
...
#locate the URL for wireshark download, make sure to update the link often
